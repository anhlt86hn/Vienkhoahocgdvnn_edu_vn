...
!function (t) {
    ...
    }), t.fn.css3 = function (t) { var i = {}, s = ["moz", "ms", "o", "webkit"]; for (var e in t) { for (var n = 0; n < s.length; n++) i["-" + s[n] + "-" + e] = t[e]; i[e] = t[e] } return this.css(i), this }, t.fn.animateRotate = function (i, s, e, n) { var a = t.speed(s, e, n), o = a.step; return this.each(function (s, e) { a.step = function (i) { return t.style(e, "transform", "rotate(" + i + "deg)"), o ? o.apply(this, arguments) : void 0 }, t({ deg: 0 }).animate({ deg: i }, a) }) }
}(jQuery);